...
public class TaskService {
    ...
    private void dispatchTasks(final List<Task> tasks){
        for(final Task eachTask : tasks){
            ...
            System.out.print("with duration "+eachTask.getTaskDurationInMilliseconds()+", ");
            System.out.println();
        }
    }
    ...
    private List<Task> sortTasksBasedOnDuration(final List<Task> currentTasks){
        Collections.sort(currentTasks, new Comparator<Task>() {
            ...
            public int compare(Task task1, Task task2){
                return task1.getTaskDurationInMilliseconds() - task2.getTaskDurationInMilliseconds();
            }
        });
        return currentTasks;
    }
    ...
    public void viewAllTasks(){
        ...
        for(final Task eachTask : allTasks){
            ...
            System.out.println("Duration: "+eachTask.getTaskDurationInMilliseconds());
        }
    }
}
